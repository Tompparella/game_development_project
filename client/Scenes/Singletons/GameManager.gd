...
var ItemsList: Dictionary = {
	...
	# Consumables
		# Mild
	"drink_red": Consumable.new("Hobo Delight", "A drink deemed worthy only for the true field professionals", 0.9, placeholder_texture, 4.2, 5),
	...
	"drink_kangaroo": Consumable.new("Kangaroo's Choice", "Oi cunt! You're few stubbies short of a six-pac", 1.6, placeholder_texture, 4.5, 10),
	...
	"liqueur_ruby": Consumable.new("Rubinrot", "It's ruby waves beckon you with their froth. An integral part of the moot", 14.5, placeholder_texture, 21.0, 175),
		# High
	...
	"liquor_pirate": Consumable.new("Yarrr-Liquid", "It's told that if you drink the whole bottle in one go, you'll actually learn to speak like a pirate", 30.0, placeholder_texture, 40.0, 750),
	"liquor_scottish": Consumable.new("Scottish Malt Juice", "For the last time, it's not 'getting wasted', it's called 'tasting', and it's a fine scottish bottle!", 55.0, placeholder_texture, 40.0, 1150),
	"liquor_herbal": Consumable.new("The Green Fairy", "It's told that people have gone insane because of this stuff. It's even been banned multiple times in history due to it generally not being very good for you. But drinking the whole bottle in four chugs? You do you buddy", 60.0, placeholder_texture, 80.0, 1750),
		# Non-Potent
